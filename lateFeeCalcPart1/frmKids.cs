...
namespace lateFeeCalcPart1
{
    public partial class frmKids : Form
    {
        ...
        private void btnCalculate_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                IsDateTime(txtDue);
                            ...
                            //numberOfMovies = int.Parse(lateMovies.Tag.ToString());
                            //lblnumber.Text = lateMovies.Tag.ToString();
                ...
                txtFee.Text = lateFee.ToString();
                

                this.Tag = lateFee;                                                          //Validate data
        ...
        private decimal CalculateLateFee(double numberOfDays, double discountPercent, int numberOfMovies)
        {
            ...
            {
                doubleLateFee = 0.15 * numberOfDays * numberOfMovies;            // New customer and 0% discount
            }
            else if (customerType == 'L' || customerType == 'l' )
            {
                doubleLateFee = 0.15 * numberOfDays * numberOfMovies * 0.90;  // Loyal customer and 10% discount
            }
            else if (customerType == 'J' || customerType == 'j' )
            {
                doubleLateFee = 0.15 * numberOfDays * numberOfMovies * 0.95;   // Junior customer and 5% discount
            }

            //Display the late fee as currency in the textbox txtFee
            return (decimal)doubleLateFee;
        }
