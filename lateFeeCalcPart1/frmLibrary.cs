...
namespace lateFeeCalcPart1
{
    public partial class frmLibrary : Form
    {
        ...
        //IsInt32 method takes two inputs and returns a boolean value
        ...
        private String CalculateLateFee(double numberOfDays, double discountPercent, int numberOfMovies)
        {
            ...
            {
                doubleLateFee = 0.57 * numberOfDays * numberOfMovies;         // New customer and 0% discount
            }
            else if (customerType == 'L' || customerType == 'l' )
            {
                doubleLateFee = 0.57 * numberOfDays * numberOfMovies * 0.90;  // Loyal customer and 10% discount
            }
            else if (customerType == 'J' || customerType == 'j' )
            {
                doubleLateFee = 0.57 * numberOfDays * numberOfMovies * 0.95;  // Junior customer and 5% discount
            }
